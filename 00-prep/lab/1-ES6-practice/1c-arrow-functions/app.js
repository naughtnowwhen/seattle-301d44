...
let sumRefactor = (a,b,c,d) => a + b + c + d;
...
console.log('objectLitRefactor', objectLitRefactor());
...
console.log('sumAndProductRefactor',sumAndProductRefactor(3,9)) 
...
console.log('messageRefactor',messageRefactor('Allie'));
...
function StudentRefactor (name, age, hometown) {
  this.name = name;
  this.age = age;
  this.hometown = hometown;
}

let joeRefactor = new StudentRefactor('joe', 198, 'Cairo');
console.log('joeRefactor', joeRefactor);
...
// this one wont refactor to an arrow function with its use of 'this'
...
Student.courseNameRefact = () => `This student is enrolled in Code 301.`;

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(Student.courseName());
console.log('courseNameRefact', Student.courseNameRefact());



// STEP 11
// How do arrow functions affect constructor functions?
Student.prototype.scope = function(whatever) {
  console.log(this);
};

// TODO: Uncomment the following line of code to see the output in the browser console
console.log('joe.scope', joe.scope('somethingSomething'));
...
// inside of .scope 'this' may try to bubble up to an outside scope but has nothing to latch onto and so returns undefined.
// with .scopeArrow its context leaks outside into the global Window Object, which is not what we want.
